...
---
 ...
 &emsp;&emsp; 本文目的在于阐述高效撰写需求文档的原则。
 主要内容描述了通用需求文档包含哪些模块，每个模块包含哪些内容以及书写过程中需要注意的点。在实践过程中会不定期进行更新，感兴趣的同学可以点击查看。
...
2. 保证团队成员沟通顺畅（保证阅读者快速获取需要的信息，节省沟通成本）
3. 制订产品质量控制标准和时间安排
<br/>
...
例如：
<div style="text-align: center">
<img width = "700" src="https://img-blog.csdnimg.cn/20200726163053323.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L2hodGh3eA==,size_16,color_FFFFFF,t_70"/>
</div>
<div style="text-align: center">
<img width = "600" src="https://img-blog.csdnimg.cn/2020072616321150.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L2hodGh3eA==,size_16,color_FFFFFF,t_70"/>
</div>
...
&emsp;&emsp; 这篇文章梳理了建立 PRD 文档的思路和需要注意的点，希望对你有所帮助。有不对或需要讨论的地方可以给我留言。
