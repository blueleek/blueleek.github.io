...
> 正所谓前人栽树，后人乘凉。本博客最先是由Huxpro制作模板，再由BY提供教程的
> 
> 感谢[Huxpro](https://github.com/huxpro)提供的博客模板和[BY](github.com/qiubaiying)提供的教程
> 
> [我的博客](http://kalicn.github.io)

# 前言
从 Jekyll 到 GitHub Pages 中间踩了许多坑，终于把我的个人博客[Kali Blog](http://kalicn.github.io)搭建出来了......
...
注册完成后搜索 `kalicn.github.io` 进入[我的仓库](https://github.com/kalicn/kalicn.github.io)
...
> 很对人反映 Disqus 评论插件加载不出来，因为 Disqus 在国内加载缓慢，所以我新集成了 Gitalk 评论插件（感谢[@FeDemo](https://github.com/FeDemo)的推荐），喜欢折腾的朋友可以看这篇：[《为博客添加 Gitalk 评论插件》](http://kalicn.github.io/2017/12/19/%E4%B8%BA%E5%8D%9A%E5%AE%A2%E6%B7%BB%E5%8A%A0-Gitalk-%E8%AF%84%E8%AE%BA%E6%8F%92%E4%BB%B6/)。 我已经在`_config.yml` 配置就好了，只需要填写参数可以了。
...
#### 保存
讲网页拉到底部，点击 `Commit changes` 提交保存
...
### **别无他求，点个 [Star](https://github.com/kalicn/kalicn.github.io) 吧**！
...
博客的文章用的是 MarkDown 格式，如果没用过 MarkDown 真的 强烈推荐 [花半个小时学习一下](http://sspai.com/25137),这个教程很详细的.
...
但是，我发现居然有人把文章的作者改成了自己，然后当成自己的文章放在自己的博客上，这就令人气愤了😡
这个博客遵循CC-BY中国大陆3.0好吗，请转发时注明作者，文章里写着呢。
